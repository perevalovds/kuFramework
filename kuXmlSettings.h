...
const string kuXmlDelim = "/";

class kuXmlSettings{

	public:
        kuXmlSettings();
        kuXmlSettings(const string& xmlFile);
        ...
        int 	getInt(const string&  tag, int defaultValue, int which = 0, bool required = true );
        double 	getDouble(const string&  tag, double defaultValue, int which = 0, bool required = true );
        ldouble getLDouble(const string&  tag, ldouble defaultValue, int which = 0, bool required = true );
        string 	getString(const string&  tag, const string &defaultValue, int which = 0, bool required = true);

        int 	setInt(const string&  tag, int value, int which = 0 );
        int 	setDouble(const string&  tag, double value, int which = 0 );
        int 	setLDouble(const string&  tag, ldouble value, int which = 0 );
        int 	setString(const string&  tag, const string &value, int which = 0 );
